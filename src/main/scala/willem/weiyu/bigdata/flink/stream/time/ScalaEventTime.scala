package willem.weiyu.bigdata.flink.stream.time
...
//    env.setStreamTimeCharacteristic(TimeCharacteristic.IngestionTime)
    ...
    val watermark = inputMap.assignAscendingTimestamps(_._1)

    //BoundedOutOfOrdernessTimestampExtractor(Time maxOutOfOrderness)允许元素延迟的maxOutOfOrderness时间
